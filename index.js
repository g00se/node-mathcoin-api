...
module.exports = class MathCoinAPI {
  ...
  */
    send(id,summa,cb){
      ...
      request(
        'https://mathbattle.12kot3k.ru/public_api.php',
        {   
          headers: {
...
get_link(summa){
  if(summa){
    return "https://m.vk.com/app6995668#t"+this.vkid+"_"+summa;
  }else {
    return "https://m.vk.com/app6995668#t"+this.vkid;
  }
